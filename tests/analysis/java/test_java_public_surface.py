...
SURFACE = {
    ...
    "get_view_dispatches": "(self, view: 'str | None' = None) -> 'List[JViewDispatch]'",
    "get_unresolved_view_dispatches": "(self) -> 'List[JViewDispatchUnresolved]'",
    "get_view_dispatchers": "(self, path: 'str') -> 'List[JCallableOverview]'",
